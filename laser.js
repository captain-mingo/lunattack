...
window.AFRAME.registerComponent('laser', {
  ...
  init: function() {
    ...
    this.laser.setAttribute('material', 'shader: standard; color: red; opacity: 1.0')
    ...
    this.glow.setAttribute('material', 'shader: standard; color: red; opacity: 0.25')
    ...
    this.tip.setAttribute('material', 'shader: standard; color: red; opacity: 0.25')
